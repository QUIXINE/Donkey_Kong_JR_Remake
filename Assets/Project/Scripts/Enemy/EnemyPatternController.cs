...
public class EnemyPatternController : MonoBehaviour
{
    ...
    static EnemyPatternController instance;
    public static EnemyPatternController Instance
    {
        get 
        { if (instance == null)
            {
                instance = FindObjectOfType(typeof(EnemyPatternController)) as EnemyPatternController;
            }
            return instance;
        }
