...
public class Fruit : MonoBehaviour
{
    ...
    public void GetPoint()
    {
        ...
        {
            ScoreVariables.ScorePlayer01 = ScoreVariables.ScorePlayer01 + fruitScore;
        }
        else
        {
            ScoreVariables.ScorePlayer02 = ScoreVariables.ScorePlayer02 + fruitScore;
        }
        ScorePopUpDisplay.PopUpScore(gameObject.transform, fruitScore);   //Pop up score
    ...
    private void OnTriggerEnter2D(Collider2D col)
    {
        ...
        if(col.gameObject.layer == 8 && collidePlayer)
        {
            ...
            if(!isCrashedEnemy01)
            {
                ...
                ScorePopUpDisplay.PopUpScore(col.gameObject.transform, fruitScore);   //Pop up score
